...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://garvinlabs.com/demo' },
};
      ...
      <header className={s.storeHeader}>
        <div className={s.storeHeaderInner}>
          ...
          <nav className={s.storeNav}>
            ...
            <a href="/"           className={s.storeNavLink}>← GarvinLabs</a>
          </nav>
      ...
      <section className={s.hero}>
        <div className={s.heroInner}>
          <div>
            ...
            <p className={s.heroSub}>Premium basics. Sustainable sourcing. Obsessive craftsmanship.</p>
          ...
          {products.map(p => (
            <div key={p.name} className={s.productCard}>
              ...
              <div className={s.productBody}>
                ...
                <p className={s.productHint}>💬 Try asking about this in the chat →</p>
              </div>
            </div>
          ))}
        </div>
